...
- (void)headPath:(NSString *)path
    ...
    NSString *percentageEscapedPath = [path stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLFragmentAllowedCharacterSet]];
...
- (void)getLikeStateForMedia:(GfycatMedia *)media withSuccess:(GfycatMediaLikeStateBlock)success failure:(nullable GfycatFailureBlock)failure; {
    ...
    [self refreshSession:^(NSDictionary *serverResponse) {
        ...
        NSString *percentageEscapedPath = [getPath stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLFragmentAllowedCharacterSet]];
